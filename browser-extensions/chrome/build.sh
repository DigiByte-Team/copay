...
APPDIR="$BUILDDIR/digibyte-chrome-extension"
ZIPFILE="digibyte-chrome-extension.zip"
...
echo "${OpenColor}${Yellow}\nThe Chrome Extension is ready at $BUILDDIR/digibyte-chrome-extension.zip${CloseColor}"
